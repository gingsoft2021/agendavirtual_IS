...
class C_Horarios extends  CI_Controller{
	...
	public function index(){
      ...
      $this->load->model('M_Horarios');
      $data['tipo'] = $this->M_Horarios->get_tipos();
      $data['table'] = $this->M_Horarios->mostrar_tabla();
      $this->load->view('usuarios/V_Administrar_Horarios.php',$data);
	...
	public function cargar_usuarios() {
        ...
        if($id_tip){
            ...
            $this->load->model('M_Horarios');
            $usuarios = $this->M_Horarios->get_usuario($id_tip);
